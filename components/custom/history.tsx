    ...
    <>
      ...
      <Sheet
        ...
        <SheetContent side="left" className="p-3 w-80 bg-muted">
          <SheetHeader>
            <VisuallyHidden.Root>
              <SheetTitle className="text-left">Geschichte</SheetTitle>
              <SheetDescription className="text-left">
                {history === undefined ? "loading" : history.length} Einträge
              </SheetDescription>
            </VisuallyHidden.Root>
          </SheetHeader>
          ...
          <div className="text-sm flex flex-row items-center justify-between">
            <div className="flex flex-row gap-2">
              <div className="dark:text-zinc-300">Geschichte</div>
          ...
          <div className="mt-10 flex flex-col">
            {user && (
              <Button
                ...
                asChild>
                <Link href="/">
                  <div>Beginne einen neuen Eintrag</div>
                      ...
                      <Link
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-xs px-1.5 py-0.5 rounded-md bg-zinc-300 dark:bg-zinc-600">
                            {chat.type === "journal" ? "Journal" : "Chat"}
                          </span>
                          <span className="text-xs px-1.5 py-0.5 rounded-md bg-zinc-300 dark:bg-zinc-600">
